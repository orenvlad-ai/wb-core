...
docset_version: "wb_core_docs_master_v67"
built_at: "2026-05-08T21:46:20Z"
build_note: "Recurring derived-sync from current authoritative docs and code-state; compact pack updated for web-vitrina canonical full-refresh/status semantics, auto-refresh schedule surface, feedbacks table overflow fix, text-color update highlighting, feedback auto-complaints schedules/run-now/tick and finalization/observability refinements."
included_roots:
  - "README.md"
  - "docs/architecture/"
  - "docs/modules/"
