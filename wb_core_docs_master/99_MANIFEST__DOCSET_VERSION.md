...
docset_version: "wb_core_docs_master_v65"
built_at: "2026-05-06T08:58:34Z"
build_note: "Recurring derived-sync from current authoritative docs and code-state; compact pack updated for WebCore app auth, auth-aware canonical probes, explicit deep refresh probe, selected-row feedback complaint submit, current `Поставки` UI label and latest hosted runtime probe/deploy semantics."
included_roots:
  - "README.md"
  - "docs/architecture/"
  - "docs/modules/"
