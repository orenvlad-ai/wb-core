...
docset_version: "wb_core_docs_master_v66"
built_at: "2026-05-08T08:53:18Z"
build_note: "Recurring derived-sync from current authoritative docs and code-state; compact pack updated for Seller Portal single-flight automation guard, canonical EU bot session and route-specific capability checks, feedback complaint batch/status-sync refinements, current SPP discountOnSite/accepted-current rollover semantics, latest-three historical source window and dark/violet unified operator UI."
included_roots:
  - "README.md"
  - "docs/architecture/"
  - "docs/modules/"
...
code_state_audited:
  ...
  - "apps/spp_metric_recompute_smoke.py"
  - "apps/spp_source_correctness_smoke.py"
  ...
  - "packages/application/feedback_review_tags.py"
  ...
  - "packages/application/sheet_vitrina_v1_temporal_policy.py"
