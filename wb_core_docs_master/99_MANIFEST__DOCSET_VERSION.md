...
docset_version: "wb_core_docs_master_v69"
built_at: "2026-05-17T10:58:00Z"
build_note: "Recurring derived-sync from current authoritative docs and code-state after canonical 1C docs fix; compact pack updated for active onec_stocks_block, web-vitrina source group onec_product_capital, stage buckets, 1C profitability metrics and governance closure."
included_roots:
  - "README.md"
  - "docs/architecture/"
  - "docs/modules/"
