...
project_upload_note: "pack changed after the live `stocks` 429 fix and checkpoint update: docs now describe batched `wb-warehouses` inventory fetch plus honest rate-limit/error semantics; confirmed external upload of this updated pack is still pending"
---
