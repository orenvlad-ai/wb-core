...
docset_version: "wb_core_docs_master_v68"
built_at: "2026-05-10T22:38:36Z"
build_note: "Recurring derived-sync from current authoritative docs and code-state; compact pack updated for Reports ready-snapshot default-read selection, runtime-managed web-vitrina auto-refresh cadence, hosted deploy/probe contract drift and latest current main checkpoints."
included_roots:
  - "README.md"
  - "docs/architecture/"
  - "docs/modules/"
...
code_state_audited:
  ...
  - "apps/sheet_vitrina_v1_feedbacks_auto_complaints_tick.py"
  ...
  - "packages/application/sheet_vitrina_v1_feedbacks_auto_complaints.py"
  - "packages/application/sheet_vitrina_v1_feedbacks_complaints.py"
  - "packages/application/sheet_vitrina_v1_auto_refresh.py"
  - "packages/application/sheet_vitrina_v1_daily_report.py"
  - "packages/application/sheet_vitrina_v1_report_snapshot_selection.py"
  - "packages/application/sheet_vitrina_v1_stock_report.py"
---
