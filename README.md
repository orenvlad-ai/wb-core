...
- `packages/application/wb_core_readonly_mcp.py`, `apps/wb_core_readonly_mcp*.py` и `artifacts/wb_core_readonly_mcp/**` как local/remote/hosted read-only MCP boundary для ChatGPT Project prompt-preparation поверх checkout/managed clone, без DevControl/deploy/execution-plane/product-plane прав;
