...
25. `Поставки -> Wildberries` добавлен как read-only WB/FBW supplies registry: official WB Supplies API adapter, server cache/sync routes, runtime SQLite persistence, compact operator table, filters and pagination without WB mutations.
