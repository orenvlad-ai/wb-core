...
update_note: "Operator UX contract: opaque shared modals, explicit readback-confirmed price/bid success, cell-only updates, simplified server-owned table preferences and nearest registered supplier inbound projection."
---
