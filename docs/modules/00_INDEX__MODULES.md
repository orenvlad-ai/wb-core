...
- `supplier_shipments_block` как server-owned supplier invoice registry с XLSX parser/runtime storage/API/UI/auth boundary and optional factory-order inbound source over deterministic matched supplier rows.
