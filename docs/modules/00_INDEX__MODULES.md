...
| `23_MODULE__REGISTRY_UPLOAD_HTTP_ENTRYPOINT_BLOCK.md` | `registry_upload_http_entrypoint_block` | `registry` | live HTTP entrypoint, thin runtime wiring и bounded current-day web-source sync подтверждены, смёржены в `main` |
