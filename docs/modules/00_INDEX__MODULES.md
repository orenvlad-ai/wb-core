...
scope: "Папка `docs/modules/`, её naming rules, статус source of truth и полный список модульных документов `01–17`."
source_basis:
...
update_note: "Обновлён после добавления `sheet_vitrina_v1_scaffold_block`; теперь индекс отражает полный комплект канонических модульных документов `01–17` и остаётся единым source of truth для `docs/modules/`."
---
