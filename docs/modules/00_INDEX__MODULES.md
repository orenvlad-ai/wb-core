...
| `23_MODULE__REGISTRY_UPLOAD_HTTP_ENTRYPOINT_BLOCK.md` | `registry_upload_http_entrypoint_block` | `registry` | live HTTP entrypoint, thin runtime wiring, bounded current-day web-source sync и zero-filled seller-funnel rejection подтверждены, смёржены в `main` |
...
| `26_MODULE__SHEET_VITRINA_V1_MVP_END_TO_END_BLOCK.md` | `sheet_vitrina_v1_mvp_end_to_end_block` | `sheet-side` | первый bounded end-to-end MVP, включая truthful blank-overwrite в live `DATA_VITRINA`, подтверждён и смёржен в `main` |
