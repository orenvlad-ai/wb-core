...
- незакрытым остаются full legacy parity, live numeric coverage для promo-backed metrics и других bounded long-tail gaps beyond current `COST_PRICE` overlay, plus actual hosted deploy rights/publish wiring, final auth-hardening и production storage binding вокруг уже repo-owned deploy contract.
