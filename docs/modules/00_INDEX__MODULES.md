...
- незакрытым остаются full legacy parity, numeric live fill beyond current public readback metrics, stable hosted runtime URL, deploy/auth-hardening и production storage binding.
