...
- незакрытым остаются full legacy parity, live numeric coverage для promo-backed metrics и других bounded long-tail gaps beyond current `COST_PRICE` overlay, stable hosted runtime URL, deploy/auth-hardening и production storage binding.
