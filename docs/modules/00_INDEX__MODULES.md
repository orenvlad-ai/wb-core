...
- operator-facing `DATA_VITRINA` снова materialize-ит server-driven current-truth rows без локального 7-metric reshape, но full legacy parity и часть live numeric coverage всё ещё не закрыты;
