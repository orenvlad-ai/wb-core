...
- operator-facing `DATA_VITRINA` теперь уже умеет legacy-aligned date-matrix layout с ростом истории вправо, но это всё ещё bounded 7-metric view поверх более широкого current truth;
