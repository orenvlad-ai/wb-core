...
- `apps/seller_portal_feedbacks_complaint_batch_smoke.py`
  - confirms April-style batch funnel accounting excludes AI `no`, lets later guarded runs move a pending candidate to submitted, and groups `already_in_journal`, `already_complained_in_wb` and description mismatch reasons.
- `apps/seller_portal_feedbacks_complaint_confirmation_smoke.py`
