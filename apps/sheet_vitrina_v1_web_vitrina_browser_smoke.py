...
def _check_operator_link(page: object, base_url: str) -> dict[str, str]:
    ...
    if tab_texts != ["Витрина", "Поставки", "Остатки / Склады", "Отчёты", "Отзывы", "Реклама", "Цены", "Управление SKU", "Исследования"]:
...
def _check_operator_screen_layout(page: object) -> dict[str, object]:
    ...
    if payload["unified_tabs"] != ["Витрина", "Поставки", "Остатки / Склады", "Отчёты", "Отзывы", "Реклама", "Цены", "Управление SKU", "Исследования"]:
...
def _read_activity_surface(page: object, *, allow_empty_log: bool = False) -> dict[str, object]:
    ...
    if group_ids != ["wb_api", "onec_product_capital", "webcore_product_capital", "seller_portal_bot", "wb_public_card_bot", "other_sources"]:
