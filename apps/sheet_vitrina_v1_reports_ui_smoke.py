...
def main() -> None:
    ...
    for token in (
        ...
        'data-report-section-button="wb-finance"',
        'data-report-section-button="stock"',
        'data-report-section-button="plan"',
        'data-report-section-panel="daily"',
        'data-report-section-panel="wb-finance" hidden',
        'id="wbFinanceReportTableWrap"',
        'class="wb-finance-table-wrap"',
        "Агентское вознаграждение / комиссия WB",
        "Маркетинг и продвижение",
        "Внутренние данные WB Core — не входят в финансовый отчёт Wildberries",
        'wb-finance-internal-divider\\"><td>" + escapeHtml(definition.label)',
        "financeCostQualityLabel(week)",
        "financeCostQualityDiagnostic(week)",
        "COST_PRICE до 01.07.2026",
        "Себестоимость WB наша, ₽/шт",
        "Себестоимость продаж",
        "Прибыль после себестоимости",
