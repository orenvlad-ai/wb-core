    ...
    with TemporaryDirectory(prefix="wb-supplies-browser-") as tmp:
        ...
        try:
            ...
            with sync_playwright() as playwright:
                ...
                expect(operator_frame.locator("#wbSuppliesWarehouseMenuButton")).to_be_visible()
                expect(operator_frame.locator("#wbSuppliesWarehouseSelect")).to_have_count(0)
                ...
                expect(operator_frame.locator("#wbSuppliesTableBody")).to_contain_text("1004", timeout=10000)
                expect(operator_frame.locator("#wbSuppliesTableBody")).to_contain_text("1005", timeout=10000)
                expect(operator_frame.locator("#wbSuppliesTableBody")).not_to_contain_text("1003")
                expect(operator_frame.locator("#wbSuppliesTableBody")).not_to_contain_text("39265540")
                operator_frame.locator("[data-wb-supplies-warehouse-action='all']").click()
                expect(operator_frame.locator("#wbSuppliesSummary")).to_contain_text("ФО: все", timeout=10000)
                expect(operator_frame.locator("#wbSuppliesTableBody")).to_contain_text("39265540", timeout=10000)
                operator_frame.locator("[data-wb-supplies-warehouse-radio][value='777']").check()
                expect(operator_frame.locator("#wbSuppliesTableBody")).to_contain_text("39265540", timeout=10000)
                ...
                operator_frame.locator("#wbSuppliesStatusMenuButton").click()
                operator_frame.locator("[data-wb-supplies-status-checkbox][value='2']").check()
                expect(operator_frame.locator("#wbSuppliesStatusMenuButton")).to_contain_text("Запланировано", timeout=10000)
                ...
                expect(operator_frame.locator("#wbSuppliesTableBody")).not_to_contain_text("1001")
                operator_frame.locator("#wbSuppliesStatusMenuButton").click()
                operator_frame.locator("[data-wb-supplies-status-checkbox][value='5']").check()
                ...
                if operator_frame.locator("#wbSupplyOverlayWarningDetails").is_visible():
                    if operator_frame.locator("#wbSupplyOverlayWarningDetails").evaluate("(node) => node.open"):
                        raise AssertionError("overlay warning details must be collapsed by default")
