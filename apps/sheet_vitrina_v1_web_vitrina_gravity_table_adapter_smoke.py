...
def main() -> None:
    ...
    if columns["section"].meta.pin != "left" or columns["section"].size != 76:
        raise AssertionError(f"section must be a left-pinned compact sticky column, got {columns['section']}")
...
def _build_view_model_payload() -> dict[str, object]:
    return {
        ...
        "columns": [
            ...
            {"id": "section", "label": "Section", "kind": "dimension", "value_type": "string", "align": "center", "sticky": "left", "width_hint": 92, "sortable": True, "filterable": True, "sort_key": None, "filter_key": "section"},
