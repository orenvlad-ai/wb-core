...
def main() -> None:
    ...
    if columns["section"].meta.pin != "left" or columns["section"].meta.align != "start" or columns["section"].size != 96:
        raise AssertionError(f"section must be a left-pinned, left-aligned moderately wider sticky column, got {columns['section']}")
...
def _build_view_model_payload() -> dict[str, object]:
    return {
        ...
        "columns": [
            ...
            {"id": "section", "label": "Section", "kind": "dimension", "value_type": "string", "align": "start", "sticky": "left", "width_hint": 112, "sortable": True, "filterable": True, "sort_key": None, "filter_key": "section"},
