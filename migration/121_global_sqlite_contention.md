...
- A logical group expands to its complete atomic semantic-operation set. Global assignment identity prevents one atomic bank row from belonging to two shipments.
