...
AUTOANSWERS_CONTRACT_VERSION: Final = "wb_autoanswers_server_v1"
...
AUTOANSWER_MODES: Final = (MODE_DRAFT_ONLY, MODE_AUTO_SAFE, MODE_AUTO_ALL)
...
AUTO_SAFE_ROUTES: Final = frozenset({"public_only", "wb_return", "wb_support"})
...
ALLOWED_TRANSITIONS: Final = {
    ...
    STATE_PROCESSING: frozenset({STATE_GENERATED, STATE_SKIPPED, STATE_RETRYABLE_ERROR, STATE_TERMINAL_ERROR}),
