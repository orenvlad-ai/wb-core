    ...
    def _run_status_sync(self, payload: Mapping[str, Any]) -> dict[str, Any]:
        ...
        return dict(
            run_status_sync_for_runtime(
                ...
                record_statuses=payload.get("record_statuses") or payload.get("status_scope") or "waiting_response",
...
def _sync_job_summary_from_report(
    ...
    *,
    ...
    return {
        ...
        "record_status_scope": aggregate.get("record_status_scope") or [],
        "records_scanned": _safe_int(aggregate.get("records_scanned")),
        "local_waiting_records_before": _safe_int(aggregate.get("local_waiting_records_before")),
        "local_satisfied_records_skipped": _safe_int(aggregate.get("local_satisfied_records_skipped")),
        "local_rejected_records_skipped": _safe_int(aggregate.get("local_rejected_records_skipped")),
        "local_error_records_skipped": _safe_int(aggregate.get("local_error_records_skipped")),
